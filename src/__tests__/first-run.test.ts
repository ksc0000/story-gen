...
import type { ChildProfileDoc, TemplateDoc } from "@/lib/types";
...
describe("first-run logic", () => {
  ...
  describe("buildFirstRunBookPayload", () => {
    it("builds a correct payload for Track A generation with template default style", () => {
      ...
      const mockChild: ChildProfileDoc & { id: string } = {
        id: "child-123",
        displayName: "Taro",
        nickname: "Taro-kun",
        age: 4,
        ...
        generationSettings: { defaultStyle: "soft_watercolor", defaultPageCount: 8, allowedPersonalization: true },
