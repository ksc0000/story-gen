 ...
 */
function buildWeeklyBuckets(reviewed: BookWithId[]): QualityTrendBucket[] {
  ...
  const bucketMap = new Map<number, BookWithId[]>();
...
export function computeQualityTrend(books: BookWithId[]): QualityTrendSummary {
