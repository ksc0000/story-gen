    ...
    <main className="flex min-h-screen items-center justify-center bg-amber-50 px-4">
      <Card className="w-full max-w-sm border-amber-200">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl text-amber-900">EhoNAI にログイン</CardTitle>
          <p className="text-sm text-gray-500">えほんAI</p>
        </CardHeader>
        <CardContent className="flex flex-col gap-4">
          <Button onClick={signInWithGoogle} variant="outline" className="w-full py-6 text-base">
          ...
          <p className="text-center text-xs text-gray-400">ログインすることで利用規約に同意したものとみなされます</p>
        </CardContent>
      </Card>
    </main>
  );
