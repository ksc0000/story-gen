...
const T6_INPUT_PROFILES = {
  bedtime: {
    ...
    s1rr: {
      label: "anchored moderate room-no-text retry",
      input: {
        childName: "さくら",
        childAge: 4,
        parentMessage:
          "きょうもたくさんあそんだね。おきにいりのうさぎさんといっしょに、しずかでやさしいひかりのおへやで、もじやなまえのないたなやはこにかこまれて、まどのそとのおつきさまとおほしさまにみまもられながら、あんしんしてぐっすりねむろうね。おやすみ、さくら。",
        colorMood: "soft warm quiet bedtime watercolor night",
        favorites: "うさぎのぬいぐるみ",
