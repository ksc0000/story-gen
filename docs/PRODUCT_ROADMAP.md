...
| **P2-11** | ダッシュボードパネル追加（CG/SJ/IM/LAT シグナル） | ✅ COMPLETE (docs/config, 2026-05-21) — [P2_GENERATION_SLO_DASHBOARD_PANELS.md](./P2_GENERATION_SLO_DASHBOARD_PANELS.md)；8パネル + 2 optional；live ダッシュボード作成は手動 |
| **P2-10b** | SJ/IM アラートポリシー定義（schema_validation / malformed_json / E005 / TIMEOUT 他） | **推奨次タスク** |
