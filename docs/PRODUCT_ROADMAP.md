...
| タスク | 内容 | 優先度 |
|--------|------|--------|
| **SLO-alert-1** | Cloud Monitoring アラート: `schema_validation` 率 > 5% / 24h | 高 |
| **SLO-alert-2** | Cloud Monitoring アラート: `malformed_json` 率 > 2% / 24h | 中 |
| **SLO-alert-3** | Cloud Monitoring アラート: `storyDurationMs` p95 > 180s | 中 |
