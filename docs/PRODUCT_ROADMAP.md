...
| **P2-10** | CG-1 アラートポリシー定義（YAML spec + gcloud コマンド + 初動対応ランブック） | ✅ COMPLETE (live, 2026-05-21) — [P2_CG1_CANDIDATE_GATE_ALERT_POLICY.md](./P2_CG1_CANDIDATE_GATE_ALERT_POLICY.md)；metric + policy 作成済み（disabled）；P2-12 で通知チャンネル設定後に enable |
