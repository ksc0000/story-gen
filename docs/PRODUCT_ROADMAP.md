...
| **prod-baseline** | 本番ユーザー 7日分データで再計測、P4-15 §7.2 更新、repair retry 判断 | ✅ COMPLETE (2026-05-23) — 35 records, real users. schema_validation rate 2.9%. |
| — | `ENABLE_SCHEMA_REPAIR_RETRY` 本番有効化判断（prod-baseline 完了後のみ） | ✅ COMPLETE (2026-06-12) — Enabled in production. |
