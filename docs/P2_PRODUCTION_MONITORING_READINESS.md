...
> **Invite kit**: Invitation templates, tester instructions, feedback form spec, and operator pre-send checklist are in `docs/P5_SOFT_LAUNCH_INVITE_KIT.md`. Cohort A execution checklist (invitation procedure, first-hour monitoring, stop conditions, incident response) is in `docs/P5_COHORT_A_EXECUTION_CHECKLIST.md`. Soft launch cohort plan is in `docs/P5_FIRST_PRODUCTION_TRAFFIC_PLAN.md`.
