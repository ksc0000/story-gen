...
const STORY_GOAL_CONSISTENCY_RULES = [
  ...
  "hiddenDetail は絵だけの小さな発見要素であり、pages[].text (本文) に書いてはいけません。キャラクターが hiddenDetail に言及したり、それに向かって行動したりすることも禁止です。",
  "visualMotif は本文と絵に出してよいが、hiddenDetail は「読者が絵の中で見つける楽しみ」としてのみ存在させてください。",
  "例えば、hiddenDetail に『すいか模様の雲』がある場合でも、物語の本文で『すいか』に触れたり、目的を『すいか探し』に変えたりしてはいけません。",
