...
const JAPANESE_STORY_TEXT_RULES = [
  ...
  "【読み聞かせの緩急】親が声に出して読むときの息づかいを意識し、長めの文と短い文を混ぜて緩急をつけてください。感情が動く瞬間や発見の瞬間には、あえて短い一文（例：「みつけた！」「わあ、すごい。」）を置くと、読み聞かせのテンポが生まれます。すべての文を同じ長さ・同じ調子にしないでください。",
...
const STORY_GOAL_CONSISTENCY_RULES = [
  ...
  "hiddenDetail や背景小物を、物語の主目的や主要な行動のきっかけにしてはいけません。",
  "visualMotif は本文と絵に出してよいが、hiddenDetail は基本的に絵だけの小さな発見要素です。",
  "hiddenDetail は「そこにひっそりと存在する」だけのものであり、主人公がそれに反応したり、追いかけたり、セリフで言及したりすることは禁止です。読者（子ども）だけが気づく「背景の遊び」に留めてください。",
  "例えば、hiddenDetail に『すいか模様の雲』がある場合でも、物語の目的を『すいか探し』に変えたり、本文（pages[].text）で『すいかみたいな くもだね』と書いたりしてはいけません。",
