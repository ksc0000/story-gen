...
const BRUSH_TEETH_8P_CHARACTER_ANCHOR_CLAUSE = "keep the same preschool child across all 8 pages: same short black bob hair, same mint-green long-sleeve pajamas, same round face proportions, same age impression around 4-5 years old, and consistent gentle picture-book facial features";
const BRUSH_TEETH_8P_OBJECT_NO_TEXT_CLAUSE = "bathroom objects must be plain and unlabeled: use solid-color cups, bottles, tubes, and shelf containers with no brand marks, no labels, no stickers, no icon-like glyphs, and no decorative text-like patterns on mirror, shelf, tiles, or packaging";
function withBrushTeeth8pImagePromptGuardrail(prompt) {
    let result = prompt;
...
const ZOO_8P_CHARACTER_ANCHOR_CLAUSE = "keep the same preschool child across all 8 pages: same short dark hair, same outfit color and style, same round face proportions, same age impression around 4 years old, and consistent gentle picture-book facial features";
const ZOO_8P_NO_SIGN_TEXT_CLAUSE = "all background signs, boards, and notices are plain-colored shapes with no glyphs or letters, no readable text of any kind";
const ZOO_8P_NO_CLOTHING_TEXT_CLAUSE = "clothing has no visible print, logo, text, letters, or readable marks";
function withZoo8pImagePromptGuardrail(prompt, options) {
    let result = prompt;
...
- スピード感や発明の楽しさを入れつつ、安全で明るい冒険にしてください。`,
        ...
        fixedStory: {
            ...
            pages: [
                buildAgeSpecificPage({
                    ...
                    early_elementary_7_8: "{childName}は、{familyMembers}といっしょに{place}へでかけました。きょうの ぼうけんが はじまります。",
                ...
                buildAgeSpecificPage({
                    ...
                    early_elementary_7_8: "大きなどうぶつ、小さなどうぶつ。{childName}は 夢中になります。",
                ...
                buildAgeSpecificPage({
                    ...
                    early_elementary_7_8: "いちばんうれしかったのは、{childName}が にっこり笑った そのしゅんかんでした。どうぶつたちの やさしさが 分かったのです。",
    ...
    "fixed-first-birthday": {
        ...
        fixedStory: {
            ...
            openingNarrationTemplate: "ろうそくの あかりが、そっと ゆれる日。{childName}と {familyMembers}の たんじょうびの思い出が はじまります。",
            pages: [
                buildAgeSpecificPage({
                ...
                buildAgeSpecificPage({
                    ...
                    preschool_3_4: "おいわいのうたのあと、{childName}は とびきりの えがおを見せてくれました。みんなの えがおが、ろうそくのひかりみたいに ひろがります。",
                    ...
                    general_child: "おいわいのうたのあと、{childName}はとびきりのえがおを見せてくれました。みんなの えがおが、ろうそくのひかりみたいに ひろがります。",
                    pageVisualRole: "emotional_closeup",
    ...
    "fixed-first-birthday-8p": {
        ...
        visualDirection: "Warm birthday memory picture-book mood with soft candlelight, family smiles, pastel balloons, and a keepsake-photo feeling over a gentle 8-page rhythm.",
        order: 4.5,
        active: true,
        ...
        fixedStory: {
            ...
            coverImagePromptTemplate: withFixedImagePromptSafety("Picture book cover illustration: a young child in front of a small birthday cake with family gathered close, warm indoor lights, soft pastel balloons, recurring tiny ribbon motif, joyful and tender keepsake mood, soft watercolor style, child-safe rounded composition, rich but not cluttered details, no text, no letters, no Japanese characters, no readable signs, no logo, no watermark"),
            titleSpreadTextTemplate: "{childName}の はじめての たんじょうび",
            openingNarrationTemplate: "あさの ひかりの なかで、きょうは ちょっと とくべつ。{childName}と {familyMembers}の たんじょうびの いちにちが はじまります。",
            pageCount: 8,
    ...
    "fixed-first-zoo-8p": {
        ...
        visualDirection: "Gentle family memory picture-book cover with warm daylight, friendly zoo atmosphere, soft smiles, and a keepsake-photo feeling over a gentle 8-page rhythm.",
        order: 3.5,
        active: true,
        systemPrompt: "固定テンプレートを使って、はじめての動物園の思い出を8ページでゆっくり残す絵本を作ります。",
        fixedStory: {
            titleTemplate: "{childName}とはじめてのどうぶつえん",
            coverImagePromptTemplate: withFixedImagePromptSafety("Picture book cover illustration: a young child standing beside a leafy zoo entrance arch with animal silhouettes and no panels, with family nearby, gentle daylight, warm welcoming atmosphere, soft watercolor style, recurring small yellow star motif tucked into the scene, child-safe and inviting composition, rich but not cluttered details, no text, no letters, no Japanese characters, no readable signs, no logo, no watermark"),
            titleSpreadTextTemplate: "{childName}と はじめての どうぶつえん",
            openingNarrationTemplate: "きょうは とくべつな日。{childName}は {familyMembers}と いっしょに、はじめての どうぶつえんへ でかけます。どんな であいが まっているかな。",
            pageCount: 8,
            layoutVariant: "8_page",
            pages: [
                buildAgeSpecificPage({
        ...
        fixedStory: {
            ...
            pages: [
                buildAgeSpecificPage({
                    ...
                    early_elementary_7_8: "{childName}は、きょうもたのしいじかんを すごしました。ゆっくり くらくなる まどのそとを見ながら、こころが やさしくなっていきます。",
                ...
                buildAgeSpecificPage({
                    ...
                    early_elementary_7_8: "うれしかったことを、ひとつずつ こころに あつめます。いちばん たのしかった しゅんかんが、ふんわり 光っています。",
                ...
                buildAgeSpecificPage({
                    ...
                    early_elementary_7_8: "おふとんに入ると、こころが ふわっと やわらかくなりました。きょうの できごとも、さっと やさしい くもの ような ことばで つつまれていきます。",
    ...
    "fixed-brush-teeth-8p": {
        ...
        visualDirection: "Bright but calm daily-habit picture-book mood with clean bathroom setting, rounded shapes, friendly routine support, and reassuring smiles over a gentle 8-page rhythm.",
        order: 7.5,
        active: true,
        ...
        fixedStory: {
            ...
            openingNarrationTemplate: "今日も歯みがきの時間がやってきました。{childName}はどんなふうにがんばるかな。",
            pageCount: 8,
            layoutVariant: "8_page",
            pages: [
                buildAgeSpecificPage({
                    ...
                    preschool_3_4: "あさだ。{childName}は、おみずをながして かおを あらいます。きょうも はみがきのじゅんびが はじまります。",
                    early_reader_5_6: "朝だ。{childName}は、お水をながして顔を洗います。鏡に映った自分を見ると、今日も がんばろう という きもちに なります。",
                    early_elementary_7_8: "朝だ。{childName}は、お水をながして顔を洗います。毎朝の おなじ しぐさが、{childName}の からだに やさしく しみこんでいます。",
                    general_child: "朝だ。{childName}は、お水をながして顔を洗います。きょうも はみがきのじゅんびが はじまります。",
                    pageVisualRole: "opening_establishing",
                    imagePromptTemplate: withBrushTeeth8pImagePromptGuardrail("Establishing wide shot of a preschool child at a bathroom sink in bright morning light, reaching for a faucet on a small step stool. The child's face is eager and alert. A bathroom mirror ahead shows the child's reflection. A colorful toothbrush cup sits on the counter with other bathroom items arranged neatly. Use only plain, unlabeled bathroom objects. Do not include readable text, product labels, logos, numbers, letters, posters, charts, or written marks anywhere in the sink area, mirror, counter, or background. A small shining star motif is tucked on the mirror frame. Soft watercolor picture book style, clean bright morning bathroom, rounded child-safe shapes, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark."),
                }),
                buildAgeSpecificPage({
                    textTemplate: "でも、歯みがきはめんどくさい。{childName}はちょっぴり ぐずぐずします。",
                    baby_toddler: "めんどくさい。ぐずぐず。",
                    preschool_3_4: "でも、はみがきはめんどくさい。{childName}はちょっぴり ぐずぐずします。おへやから あぶくの おとが きこえてきました。",
                    early_reader_5_6: "でも、歯みがきはめんどくさい。{childName}はちょっぴり ぐずぐずします。でも、{childName}は知っています。やってみると たのしいことを。",
                    early_elementary_7_8: "でも、歯みがきはめんどくさい。{childName}はちょっぴり ぐずぐずします。誰もが そう感じる その気持ちを、{childName}は素直に 表しています。",
                    general_child: "でも、歯みがきはめんどくさい。{childName}はちょっぴり ぐずぐずします。おへやから あぶくの音が きこえてきました。",
                    pageVisualRole: "setback_or_question",
                    imagePromptTemplate: withBrushTeeth8pImagePromptGuardrail("Medium shot of the child sitting on the bathroom floor with a slightly pouty or uncertain expression, looking at the toothbrush with hesitation. The toothbrush and solid-colored toothpaste tube sit on the counter above with no labels, no brand marks, no text. Soft bubbles or steam are visible near the sink. The room is still bright and welcoming despite the child's reluctance. A small shining star motif appears on the floor tile. Soft watercolor picture book style, relatable reluctance without negativity, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.")
                }),
                buildAgeSpecificPage({
                    textTemplate: "でも、はぶらしを握ると、あぶくが ふわっと 出てきました。あ、楽しい。",
                    baby_toddler: "あぶく。ふわっ。たのしい。",
                    preschool_3_4: "でも、はぶらしを にぎると、あぶくが ふわっと でてきました。あ、たのしい。{childName}の めが きらりと ひかります。",
                    early_reader_5_6: "でも、はぶらしを握ると、あぶくが ふわっと 出てきました。あ、楽しい。小さな星のような あぶくが、{childName}の 心も ぷくぷくと 膨らませます。",
                    early_elementary_7_8: "でも、はぶらしを握ると、あぶくが ふわっと 出てきました。あ、楽しい。めんどくさいと思っていた その気持ちが、ふんわり 変わっていく体験をします。",
                    general_child: "でも、はぶらしを握ると、あぶくが ふわっと 出てきました。あ、楽しい。{childName}の目が きらりと 光ります。",
                    pageVisualRole: "discovery",
                    imagePromptTemplate: withBrushTeeth8pImagePromptGuardrail("Medium action shot of the child actively brushing with delight. The toothbrush fills with foam bubbles that float in soft white clouds near the mouth. The child's expression shifts from reluctance to joy, eyes bright. Soft bubbles drift near the sink. A small shining star motif appears on the toothbrush handle or bubbles. Bright bathroom light. Soft watercolor picture book style, transformation moment, dynamic but gentle, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark."),
                }),
                buildAgeSpecificPage({
                    textTemplate: "しゃかしゃか。前歯をもっと頑張る。ぴかぴかになれ。",
                    baby_toddler: "しゃかしゃか。ぴかぴか。",
                    preschool_3_4: "しゃかしゃか。まえばを もっと がんばる。ぴかぴかになれ。{childName}は、はの ひとつひとつに きもちを こめて みがきます。",
                    early_reader_5_6: "しゃかしゃか。前歯をもっと頑張る。ぴかぴかになれ。{childName}は、小さな手で せいいっぱい 磨いています。",
                    early_elementary_7_8: "しゃかしゃか。前歯をもっと頑張る。ぴかぴかになれ。{childName}は、じぶんの歯を大事にしようという 気持ちが、ぽかぽかと 湧き上がるのを感じます。",
                    general_child: "しゃかしゃか。前歯をもっと頑張る。ぴかぴかになれ。{childName}は、歯のひとつひとつに 気持ちを こめて 磨きます。",
                    pageVisualRole: "action",
                    imagePromptTemplate: withBrushTeeth8pImagePromptGuardrail("Action-focused medium shot of the child concentrating hard on brushing the front teeth. The child's hands are on both sides of the toothbrush, mouth open with gentle foam. Keep the toothbrush, toothpaste tube, cup, mirror, and counter completely plain and unlabeled, with no brand marks, product labels, letters, numbers, or readable markings. The toothpaste tube must be completely blank, plain white, and label-free, with no printed text, fake text, logo, brand mark, decorative writing, symbols, numbers, or letter-like shapes. If needed, turn the tube away from the viewer or partially hide it behind the cup so no product surface can show markings. The mirror reflects the child's focused, determined face. Soft bubbles float around the mouth area. A small shining star motif appears on the mirror frame or tooth foam. Bright clean bathroom. Soft watercolor picture book style, determination and effort, dynamic but gentle, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark."),
                }),
                buildAgeSpecificPage({
                    textTemplate: "さらに、奥歯も、そっと探検する。ここにも汚れがあるのか。見つけるぞ。",
                    baby_toddler: "奥歯も。そっと。きれいきれい。",
                    preschool_3_4: "さらに、おくばも、そっと たんけんする。ここにも よごれがあるのか。みつけるぞ。{childName}は、かがみを のぞきながら いっしょうけんめい さがします。",
                    early_reader_5_6: "さらに、奥歯も、そっと探検する。ここにも汚れがあるのか。見つけるぞ。{childName}は、自分の歯の中を 小さな冒険者のように 探検しています。",
                    early_elementary_7_8: "さらに、奥歯も、そっと探検する。ここにも汚れがあるのか。見つけるぞ。{childName}は、歯の裏側まで 丁寧に 磨くことで、自分の体を 大事にしている という 実感を 深めていきます。",
                    general_child: "さらに、奥歯も、そっと探検する。ここにも汚れがあるのか。見つけるぞ。{childName}は、鏡を覗きながら 一生懸命 探します。",
                    pageVisualRole: "object_detail",
                    imagePromptTemplate: withBrushTeeth8pImagePromptGuardrail("Object-detail close shot focused on the child's mouth area as the toothbrush moves toward the back teeth, seen in the mirror. The child tilts the head slightly to the side, concentrating. Soft foam reveals gentle brushing action. Use a plain mirror frame and simple bathroom objects only. Avoid pseudo-text, decorative symbols, label-like marks, written notes, product labels, posters, charts, letters, or numbers. The mirror reflects the child's focused expression. A small shining star motif appears on the mirror edge. Soft bathroom light highlighting the brushing motion. Soft watercolor picture book style, intimate exploration, gentle care, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark."),
                }),
                buildAgeSpecificPage({
                    textTemplate: "その様子を、おかあさん（またはおとうさん）が、やさしく見守っていました。",
                    baby_toddler: "ママも見てる。やさしい。",
                    preschool_3_4: "そのようすを、おかあさん（またはおとうさん）が、やさしく みまもっていました。{childName}は、その しせんに きづき、もっと がんばろうと おもいました。",
                    early_reader_5_6: "その様子を、家族が、やさしく見守っていました。{childName}は、その暖かい視線を感じて、一人じゃないんだと 思いました。",
                    early_elementary_7_8: "その様子を、家族が、やさしく見守っていました。{childName}は、サポートされていることの ありがたさを 無意識に受け取り、その気持ちが 力に 変わっていきます。",
                    general_child: "その様子を、おかあさん（またはおとうさん）が、やさしく見守っていました。{childName}は、その視線に 気づき、もっと 頑張ろう と 思いました。",
                    pageVisualRole: "emotional_closeup",
                    imagePromptTemplate: withBrushTeeth8pImagePromptGuardrail("Close-up emotional shot of the child brushing intently in the mirror while a family member (parent) stands in soft focus in the background, watching with a warm, proud smile. The parent's hand rests gently on the child's shoulder or nearby. The parent's face shows gentle encouragement without pressure. The mirror frame is plain and simplified with no decorative patterns or pseudo-text marks. The bathroom wall behind the mirror is plain solid color with no posters, charts, or label-like objects. A small shining star motif appears on the parent's shirt or nearby. Soft warm bathroom light. Soft watercolor picture book style, supportive family moment, tender and reassuring, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark."),
                }),
                buildAgeSpecificPage({
                    textTemplate: "仕上げに、口をゆすぐ。ぐちゅぐちゅ。どんどん、きれいになる。",
                    baby_toddler: "ぐちゅぐちゅ。ぴかぴか。できた。",
                    preschool_3_4: "しあげに、くちをゆすぐ。ぐちゅぐちゅ。どんどん、きれいになる。{childName}は、さいごの しあげに きあいが はいります。",
                    early_reader_5_6: "仕上げに、口をゆすぐ。ぐちゅぐちゅ。どんどん、きれいになる。{childName}は、水のぬくもりを感じながら、全部 終わったという 喜びが こみ上げます。",
                    early_elementary_7_8: "仕上げに、口をゆすぐ。ぐちゅぐちゅ。どんどん、きれいになる。{childName}は、最後の最後まで 丁寧に 仕上げることで、自分の 努力を 完成させる 喜びを 知ります。",
                    general_child: "仕上げに、口をゆすぐ。ぐちゅぐちゅ。どんどん、きれいになる。{childName}は、最後の仕上げに 気合いが入ります。",
                    pageVisualRole: "payoff",
                    imagePromptTemplate: withBrushTeeth8pImagePromptGuardrail("Wide payoff shot of the child rinsing vigorously, water streaming over the face with gentle splashes, foam and bubbles spinning away. The child's expression is determined and joyful. The bathroom counter is tidy around them. A small shining star motif appears on the rinse cup or soap dispenser. Clear water, bright light, sense of completion. Soft watercolor picture book style, accomplishment and freshness, dynamic but clean, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark."),
                }),
                buildAgeSpecificPage({
                    textTemplate: "{parentMessage}",
                    baby_toddler: "{parentMessage}",
    ...
    "fixed-sharing-friends": {
        ...
        fixedStory: {
            ...
            openingNarrationTemplate: "きょうは、{childName}が おともだちと すごすなかで、{lessonToTeach}の あたたかさに そっと きづいていく おはなしです。",
            pages: [
                buildAgeSpecificPage({
    ...
    "fixed-sleepy-moon-adventure": {
        ...
        visualDirection: "Cozy bedtime picture-book mood with soft moonlight, fluffy blankets, gentle imagination scenes, and calm reassuring expressions.",
        order: 11,
        active: true,
        systemPrompt: "固定テンプレートを使って、寝る前の安心感をやさしく描く絵本を作ります。",
        fixedStory: {
            titleTemplate: "{childName}とおつきさまのおやすみぼうけん",
            coverImagePromptTemplate: withFixedImagePromptSafety("Picture book cover illustration: a sleepy child in cozy pajamas looking at a bright moon from a bedroom window, soft blanket draped around shoulders, tiny glowing star motif, calm and reassuring bedtime mood, soft watercolor style, rounded child-safe composition, rich but not cluttered details, no text, no letters, no Japanese characters, no readable signs, no logo, no watermark"),
            titleSpreadTextTemplate: "おつきさまと おやすみぼうけん",
            openingNarrationTemplate: "よるのしずかな へやで、{childName}は まどのむこうの おつきさまを みつけました。",
            pages: [
                buildAgeSpecificPage({
                    textTemplate: "ベッドのうえで、{childName}はまどのそとのおつきさまを見つけました。",
                    baby_toddler: "{childName}、おつきさま みーつけた。",
                    preschool_3_4: "ベッドのうえで、{childName}は まどのそとの おつきさまを みつけました。",
                    early_reader_5_6: "ベッドのうえで、{childName}は まどのそとの おつきさまを みつけました。しずかな ひかりが こころを やわらかくします。",
                    early_elementary_7_8: "ベッドのうえで、{childName}は まどのそとの おつきさまを みつけました。やさしい ひかりに つつまれて、きょうの つかれが すこしずつ ほどけていきます。",
                    general_child: "ベッドのうえで、{childName}はまどのそとのおつきさまを見つけました。",
                    pageVisualRole: "opening_establishing",
                    imagePromptTemplate: "Establishing wide shot of a cozy bedroom at night. A child sits upright on bed under a soft blanket, gazing through a window at a bright round moon. Plush toys and a warm bedside lamp create a secure bedtime atmosphere. A tiny glowing star motif appears near the window curtain. Moonlight and warm lamp light blend softly. Watercolor picture book style, rich but uncluttered composition, child-safe rounded shapes. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "{childName}は、ふわふわの雲やきらきらの星をそうぞうしました。",
                    baby_toddler: "ふわふわ くも、きらきら ほし。",
                    preschool_3_4: "{childName}は、ふわふわの くもや きらきらの ほしを そうぞうしました。",
                    early_reader_5_6: "{childName}は、ふわふわの くもや きらきらの ほしを そうぞうしました。やさしい ぼうけんが こころのなかで ひろがります。",
                    early_elementary_7_8: "{childName}は、ふわふわの くもや きらきらの ほしを そうぞうしました。へやにいながら、しずかな よるの そらを たびしている きぶんになります。",
                    general_child: "{childName}は、ふわふわの雲やきらきらの星をそうぞうしました。",
                    pageVisualRole: "discovery",
                    imagePromptTemplate: "Medium discovery shot of a child smiling softly on bed while imagining cloud paths and star shapes floating gently around the room like dream symbols. The bedroom remains clear and cozy, with moonlight entering from the window. A small star motif appears among the symbolic floating shapes. Safe, calm pretend atmosphere with no danger elements. Soft watercolor picture book style, dreamy but grounded composition, rich but uncluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "おつきさまが「きょうもだいじょうぶ」と見まもってくれているようでした。",
                    baby_toddler: "だいじょうぶ、って おつきさま。",
                    preschool_3_4: "おつきさまが「きょうも だいじょうぶ」と 見まもってくれているようでした。",
                    early_reader_5_6: "おつきさまが「きょうも だいじょうぶ」と 見まもってくれているようでした。{childName}の こころは ほっと あたたかくなります。",
                    early_elementary_7_8: "おつきさまが「きょうも だいじょうぶ」と そっと 見まもってくれているようでした。{childName}の こころは、しずかに ほぐれていきます。",
                    general_child: "おつきさまが「きょうもだいじょうぶ」と見まもってくれているようでした。",
                    pageVisualRole: "emotional_closeup",
                    imagePromptTemplate: "Emotional close-up of a child resting on pillow with peaceful eyes, moonlight softly illuminating the face. The child hugs a blanket edge with comfort. Outside window, the moon appears gentle and protective without human text or symbols. A tiny star motif glows near the pillow seam. Intimate calm framing, watercolor picture book style, warm reassurance and quiet confidence, rich but uncluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "{parentMessage}",
                    baby_toddler: "{parentMessage}",
    ...
    "fixed-cardboard-rocket": {
        ...
        visualDirection: "Warm imaginative playroom mood with cardboard rocket pretend play, symbolic stars and planets, and safe adventurous excitement.",
        order: 12,
        active: true,
        systemPrompt: "固定テンプレートを使って、安心できる想像の宇宙ごっこ絵本を作ります。",
        fixedStory: {
            titleTemplate: "{childName}のダンボールロケットしゅっぱつ",
            coverImagePromptTemplate: withFixedImagePromptSafety("Picture book cover illustration: a joyful child beside a handmade cardboard rocket in a cozy playroom, symbolic stars and planets floating as imagination motifs, tiny comet motif recurring, safe pretend-adventure mood, soft watercolor style, rounded child-safe composition, rich but not cluttered details, no text, no letters, no Japanese characters, no readable signs, no logo, no watermark"),
            titleSpreadTextTemplate: "ダンボールロケットで しゅっぱつ",
            openingNarrationTemplate: "あるひ、{childName}は へやで ダンボールロケットを みつけました。きょうは そうぞうの うちゅうへ しゅっぱつです。",
            pages: [
                buildAgeSpecificPage({
                    textTemplate: "{childName}はへやのすみで、ダンボールロケットを見つけました。",
                    baby_toddler: "{childName}、ロケット みつけた。",
                    preschool_3_4: "{childName}は へやのすみで、ダンボールロケットを みつけました。",
                    early_reader_5_6: "{childName}は へやのすみで、ダンボールロケットを みつけました。ここから どんな ぼうけんが はじまるのか むねが どきどきします。",
                    early_elementary_7_8: "{childName}は へやのすみで、ダンボールロケットを みつけました。ふだんの へやが、これから うちゅうへの しゅっぱつちに かわっていきます。",
                    general_child: "{childName}はへやのすみで、ダンボールロケットを見つけました。",
                    pageVisualRole: "opening_establishing",
                    imagePromptTemplate: "Establishing wide shot of a cozy playroom with a handmade cardboard rocket near toy shelves and cushions. A child stands beside the rocket with surprised excitement, one hand touching the cardboard surface. A tiny comet motif appears on a nearby cushion. Warm indoor light and tidy safe environment emphasize pretend play. Watercolor picture book style, clear playroom context, rich but uncluttered composition. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "ロケットにのりこんで、{childName}のそうぞうのうちゅうがひろがります。",
                    baby_toddler: "ロケット のって、しゅっぱつ。",
                    preschool_3_4: "ロケットに のりこんで、{childName}の そうぞうの うちゅうが ひろがります。",
                    early_reader_5_6: "ロケットに のりこんで、{childName}の そうぞうの うちゅうが ひろがります。へやの あかりも、まるで ほしの ひかりみたいに みえてきました。",
                    early_elementary_7_8: "ロケットに のりこんで、{childName}の そうぞうの うちゅうが ひろがります。ふつうの へやの けしきが、わくわくする うちゅうステーションに かわっていきます。",
                    general_child: "ロケットにのりこんで、{childName}のそうぞうのうちゅうがひろがります。",
                    pageVisualRole: "discovery",
                    imagePromptTemplate: "Discovery medium shot from inside or beside a cardboard rocket cockpit in a playroom. The child pretends to launch, smiling with focused excitement while symbolic stars and orbit lines appear as imagination overlays. The real room remains visible to keep the safe pretend-play context. Tiny comet motif appears near the rocket fin. Watercolor picture book style, dynamic but gentle framing, rich but uncluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "きらきらの星やまるい惑星を見て、{childName}は胸がわくわくしました。",
                    baby_toddler: "きらきら ほし、わくわく。",
                    preschool_3_4: "きらきらの ほしや まるい わくせいを見て、{childName}は わくわくしました。",
                    early_reader_5_6: "きらきらの ほしや まるい わくせいを見て、{childName}は むねが わくわくしました。みつけるたびに うれしい きもちが ふえていきます。",
                    early_elementary_7_8: "きらきらの ほしや まるい わくせいを見て、{childName}は むねが わくわくしました。そうぞうの せかいで みつける ひとつひとつが、じぶんだけの たからものになります。",
                    general_child: "きらきらの星やまるい惑星を見て、{childName}は胸がわくわくしました。",
                    pageVisualRole: "emotional_closeup",
                    imagePromptTemplate: "Emotional close-up of the child inside the cardboard rocket, face lit by soft imaginative starlight effects. Symbolic planets and stars float around as dreamy overlays while maintaining a safe playful tone. The child's expression shows awe and joy without fear. Tiny comet motif appears near the control panel sticker area without readable text. Watercolor picture book style, intimate excitement framing, rich but uncluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "{parentMessage}",
                    baby_toddler: "{parentMessage}",
    ...
    "fixed-rainy-day-puddle": {
        ...
        visualDirection: "Cozy rainy-day picture-book mood with reflective puddles, soft umbrellas, gentle outdoor light, and warm after-rain comfort.",
        order: 13,
        active: true,
        systemPrompt: "固定テンプレートを使って、雨の日でも楽しい発見を見つける絵本を作ります。",
        fixedStory: {
            titleTemplate: "{childName}とあめの日のみずたまり",
            coverImagePromptTemplate: withFixedImagePromptSafety("Picture book cover illustration: a cheerful child in a bright raincoat standing beside a shimmering puddle on a safe garden path, soft drizzle and gentle umbrella shapes, cozy rainy-day mood, watercolor storybook style, recurring tiny raindrop motif, rich but not cluttered details, no text, no letters, no Japanese characters, no readable signs, no logo, no watermark"),
            titleSpreadTextTemplate: "あめの日の みずたまり",
            openingNarrationTemplate: "そとは しとしと あめもよう。{childName}は まどのそとに きらりとひかる みずたまりを みつけました。",
            pages: [
                buildAgeSpecificPage({
                    textTemplate: "まどのそとには、やさしい雨がふっていました。{childName}は、きらきらのみずたまりを見つけます。",
                    baby_toddler: "あめ しとしと。みずたまり きらり。",
                    preschool_3_4: "まどのそとには、やさしい雨がふっていました。{childName}は、きらきらの みずたまりを みつけます。",
                    early_reader_5_6: "まどのそとには、やさしい雨が ふっていました。{childName}は、きらきらの みずたまりを 見つけて、ちょっと うれしい気持ちになります。",
                    early_elementary_7_8: "まどのそとには、やさしい雨が ふっていました。{childName}は、灰色の空のしたで ひかる みずたまりを 見つけて、雨の日にも たのしい発見があると 気づきます。",
                    general_child: "まどのそとには、やさしい雨がふっていました。{childName}は、きらきらの みずたまりを みつけます。",
                    pageVisualRole: "opening_establishing",
                    imagePromptTemplate: "Establishing wide shot from inside a cozy home looking toward a rainy garden path through a window. A child stands by the window with curious eyes, noticing a shimmering puddle outside. Soft indoor warm light contrasts with cool rainy daylight outdoors. A tiny raindrop motif appears near the window frame. Child-safe, calm atmosphere with no nearby vehicles and no road hazard context. Watercolor picture book style, layered foreground and background, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "レインコートをきて、{childName}はそっとそとへでました。みずたまりがまるで宝ものみたいです。",
                    baby_toddler: "レインコート きて、そとへ ぴょこん。",
                    preschool_3_4: "レインコートをきて、{childName}は そっと そとへでました。みずたまりが きらきら しています。",
                    early_reader_5_6: "レインコートをきて、{childName}は そっと そとへでました。みずたまりを ひとつ見つけるたび、わくわくが ふえていきます。",
                    early_elementary_7_8: "レインコートをきて、{childName}は そっと そとへでました。雨の音を ききながら みずたまりを のぞくと、ふだんとちがう せかいが ひらいていきます。",
                    general_child: "レインコートをきて、{childName}はそっとそとへでました。みずたまりがまるで宝ものみたいです。",
                    pageVisualRole: "discovery",
                    imagePromptTemplate: "Medium discovery shot of a child in a raincoat and rain boots standing on a safe garden walkway, gently approaching a puddle while holding an umbrella. Rain droplets create soft rings on water. A tiny raindrop motif is reflected near the puddle edge. The environment is child-safe, peaceful, and away from vehicle traffic or dangerous crossing context. Watercolor picture book style, clear emotional storytelling composition, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "みずたまりには空と{childName}のえがおがうつって、{childName}はうれしくなりました。",
                    baby_toddler: "みずたまりに そら。{childName} にこっ。",
                    preschool_3_4: "みずたまりには そらと {childName}の えがおが うつって、{childName}は うれしくなりました。",
                    early_reader_5_6: "みずたまりには そらと {childName}の えがおが うつっていました。{childName}は、雨の日の きれいな ひみつを 見つけた気分です。",
                    early_elementary_7_8: "みずたまりには 空と {childName}の えがおが うつっていました。雨のしずくが つくる 小さなゆらぎを見て、{childName}は こころまで きらきら してきます。",
                    general_child: "みずたまりには空と{childName}のえがおがうつって、{childName}はうれしくなりました。",
                    pageVisualRole: "emotional_closeup",
                    imagePromptTemplate: "Emotional close-up of a child crouching beside a puddle, smiling as reflection shows sky, clouds, and the child face in rippling water. Small raindrops create delicate circles across the reflection. A tiny raindrop motif appears in the reflected light pattern. Gentle rain ambiance, cozy and hopeful mood, child-safe setting. Watercolor picture book style, intimate framing with soft depth, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "おうちにもどって、{childName}は「雨の日もたのしかったね」とにっこりしました。{parentMessage}",
                    baby_toddler: "ただいま。あめの日 たのしかったね。{parentMessage}",
                    preschool_3_4: "おうちにもどって、{childName}は「雨の日も たのしかったね」と にっこりしました。さいごに、{parentMessage}",
                    early_reader_5_6: "おうちにもどって、{childName}は「雨の日も たのしかったね」と にっこり。ぬれた くつを ならべながら、{parentMessage}",
                    early_elementary_7_8: "おうちにもどって、{childName}は「雨の日も たのしかったね」と にっこりしました。きょうの発見を 思い出しながら、{parentMessage}",
                    general_child: "おうちにもどって、{childName}は「雨の日もたのしかったね」とにっこりしました。{parentMessage}",
                    pageVisualRole: "quiet_ending",
    ...
    "fixed-little-helper": {
        ...
        visualDirection: "Warm family home picture-book mood with safe helper tasks, gentle gratitude, and calm everyday confidence-building moments.",
        order: 14,
        active: true,
        systemPrompt: "固定テンプレートを使って、小さなお手伝いの達成感をやさしく描く絵本を作ります。",
        fixedStory: {
            titleTemplate: "{childName}のちいさなおてつだい",
            coverImagePromptTemplate: withFixedImagePromptSafety("Picture book cover illustration: a smiling child carrying a small basket of folded towels in a cozy family room, warm family members nearby, gentle gratitude mood, recurring tiny heart-spark motif, watercolor storybook style, child-safe rounded composition, rich but not cluttered details, no text, no letters, no Japanese characters, no readable signs, no logo, no watermark"),
            titleSpreadTextTemplate: "ちいさなおてつだい",
            openingNarrationTemplate: "あるひの おうちで、{childName}は みんなの やくにたてる ちいさな おてつだいを さがしはじめました。",
            pages: [
                buildAgeSpecificPage({
                    textTemplate: "おうちでは、みんながおかたづけやじゅんびでいそがしそうです。{childName}はそれを見ていました。",
                    baby_toddler: "みんな じゅんび。{childName} みてる。",
                    preschool_3_4: "おうちでは、みんながおかたづけや じゅんびで いそがしそうです。{childName}は それを 見ていました。",
                    early_reader_5_6: "おうちでは、みんなが おかたづけや じゅんびで いそがしそうです。{childName}は、じぶんにも できることが あるかなと かんがえます。",
                    early_elementary_7_8: "おうちでは、みんなが おかたづけや じゅんびで いそがしそうです。{childName}は、だれかの たすけに なることを してみたいと 思いました。",
                    general_child: "おうちでは、みんながおかたづけやじゅんびでいそがしそうです。{childName}はそれを見ていました。",
                    pageVisualRole: "opening_establishing",
                    imagePromptTemplate: "Establishing wide shot of a cozy family room connected to a safe kitchen area. Family members organize cushions, laundry, and table items while a child watches with interest, ready to help. A tiny heart-spark motif appears on a basket handle. Warm daylight, calm home atmosphere, child-safe environment with no hazardous tools visible. Watercolor picture book style, layered composition, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "{childName}は、できそうなおてつだいを見つけました。小さなかごをもって、タオルをはこびます。",
                    baby_toddler: "おてつだい みつけた。はこぶよ。",
                    preschool_3_4: "{childName}は、できそうな おてつだいを 見つけました。ちいさな かごをもって、タオルを はこびます。",
                    early_reader_5_6: "{childName}は、できそうな おてつだいを 見つけました。ちいさな かごを しっかり もって、ていねいに タオルを はこびます。",
                    early_elementary_7_8: "{childName}は、じぶんにも できる おてつだいを 見つけました。バランスを とりながら かごを はこんで、すこしずつ たのもしい うごきに かわっていきます。",
                    general_child: "{childName}は、できそうなおてつだいを見つけました。小さなかごをもって、タオルをはこびます。",
                    pageVisualRole: "discovery",
                    imagePromptTemplate: "Medium discovery shot of a child carefully carrying a small basket with folded towels across a cozy room. Family member nearby offers a supportive smile at child eye level. A tiny heart-spark motif appears near the folded towels. Safe simple household task only, with no hazardous tools or heat-source context visible. Watercolor picture book style, clear action framing, warm and encouraging mood, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    ...
                    early_reader_5_6: "「ありがとう」と いわれて、{childName}の こころは ぽかぽかに なりました。だれかの 役に立てたことが、とても うれしかったのです。",
                    early_elementary_7_8: "「ありがとう」と いわれて、{childName}の こころは ぽかぽかに なりました。小さな こうどうでも、だれかを たすけられるのだと 実感します。",
                    general_child: "「ありがとう」と言われて、{childName}のこころはぽかぽかになりました。",
                    pageVisualRole: "emotional_closeup",
                    imagePromptTemplate: "Emotional close-up of a child receiving warm thanks from a family member, both smiling with soft eye contact. The child holds an empty basket proudly after helping. A tiny heart-spark motif glows near their hands. Cozy indoor lighting, gentle family connection, and safe environment. Watercolor picture book style, intimate emotional composition, rich but not cluttered. No text, no letters, no Japanese characters, no readable signs, no logo, no watermark.",
                }),
                buildAgeSpecificPage({
                    textTemplate: "{childName}は「またおてつだいしたいな」と思いました。{parentMessage}",
                    baby_toddler: "また おてつだい したいな。{parentMessage}",
                    preschool_3_4: "{childName}は「また おてつだい したいな」と おもいました。さいごに、{parentMessage}",
                    early_reader_5_6: "{childName}は「また おてつだい したいな」と おもいました。できることが ふえるたび、じぶんの こころも つよくなる気がします。さいごに、{parentMessage}",
                    early_elementary_7_8: "{childName}は「また おてつだい したいな」と おもいました。ちいさな行動が 家族の えがおに つながることを知って、{parentMessage}",
                    general_child: "{childName}は「またおてつだいしたいな」と思いました。{parentMessage}",
                    pageVisualRole: "quiet_ending",
