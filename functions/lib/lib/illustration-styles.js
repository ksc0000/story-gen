...
exports.ILLUSTRATION_STYLE_PROFILES = void 0;
exports.getIllustrationStyleProfile = getIllustrationStyleProfile;
exports.ILLUSTRATION_STYLE_PROFILES = [
    {
        id: "soft_watercolor",
        name: "やさしい水彩",
    ...
    },
    {
        ...
        styleBible: "Simple flat illustration style, bright clean colors, readable shapes, minimal shadows, modern child-friendly picture book layout.",
        negativeStyleRules: [
            "Do not add readable text, logos, or watermarks.",
    ...
    },
    {
        ...
        styleBible: "Rounded 3D toy storybook style, clay-like forms, playful miniature diorama feeling, soft plastic texture, bright child-safe lighting.",
        negativeStyleRules: [
            "Do not add readable text, logos, or watermarks.",
    ...
    },
    {
        ...
        styleBible: "Paper cut collage picture book style, layered handmade paper textures, tactile edges, warm craft feeling, playful child-friendly composition.",
        negativeStyleRules: [
            "Do not add readable text, logos, or watermarks.",
    ...
    },
    {
        ...
        styleBible: "Gentle pencil sketch picture book style, delicate line art, subtle color tinting, nostalgic quiet mood, soft hand-drawn feeling.",
        negativeStyleRules: [
            "Do not add readable text, logos, or watermarks.",
...
function getIllustrationStyleProfile(style) {
    return (exports.ILLUSTRATION_STYLE_PROFILES.find((profile) => profile.id === style) ??
        exports.ILLUSTRATION_STYLE_PROFILES[0]);
}
//# sourceMappingURL=illustration-styles.js.map